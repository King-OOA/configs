...
private:
    ...
    void detectPeriods(uint *lo, uint bLen, uint D, uint &periodLength, int &maxNbPeriods) 
    {
        periodLength = 0;
        maxNbPeriods = 0;
    ...
    bool detectAndTreatPeriods(uint bStart, uint bLen, uint D, uint D2, uchar bucketStartFlag) 
    {
        uint period;
        int maxPeriodLen;
    ...
    bool treatPeriodLeaders(uint bStart, uint bLen, uint D, uint D2, uchar bucketStartFlag, uint periodLength) 
    {
	...
	int populate(int leaders, uint periodLength, uint bStart, uint bLen, uint bucketStartFlag, uint *suffixBuff, uint *dest, bword *buffer) 
    {
    ...
    void handleBucketRepeatsOnly(uint bStart, uint bLen, uint D, uint D2, uchar bucketStartFlag) 
    {
        detectAndTreatPeriods(bStart, bLen, D, D2, bucketStartFlag);
    }

    void handleBucketNoRepeats(uint bStart, uint bLen, uint D, uint D2, uchar bucketStartFlag) 
    {
        bucketBuffVec.reserve(bLen);
    ...
    void handleBucketWithRepeats(uint bStart, uint bLen, uint D, uint D2, uchar bucketStartFlag) 
    {
